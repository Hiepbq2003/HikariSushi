                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-hover text-nowrap">
                                    <thead>
                                        <tr>
                                            <th  class="text_page_head" >ID đơn hàng</th>
                                            <th class="text_page_head">Tên</th>
                                            <th class="text_page_head">Tổng số tiền</th>
                                            <th class="text_page_head">Ngày đặt đơn</th>
                                            <th class="text_page_head">Trạng thái</th>
                                    ...
                                    <tbody id="content">
                                        <c:forEach items="${listAllOrder}" var="i">
                                            <tr>
                                                <td class="text_page" style="font-weight: 500">${i.orderId}</td>
                                                <td class="text_page" style="font-weight: 500">${i.userName}</td> <!-- Hiển thị tên đăng nhập -->
                                                <td class="text_page" style="font-weight: 500">${i.total}</td>
                                                <td class="text_page" style="font-weight: 500">${i.date}</td> <!-- Hiển thị địa chỉ -->
                                                <td id="status" class="text_page">
                                                    ${i.orderStatus?"Delivered":"Not delivery"}
                                                    <c:if test="${!i.orderStatus}">
