    ...
    <body>
                        ...
                        <div class="card">
                            <div class="card-header py-3">
                                <h3 class="mb-0 text-center">
                                    <strong>Lợi nhuận theo tuần</strong>
                                    ...
                                    <button style="width: 100px; padding: 0" class="form-control" type="button" onclick="submitForm()">Chọn tuần</button>
                                </form>
                            </h3>
                        </div>
                        <div class="card-body">
        ...
        <script type="text/javascript">// Graph
                                        ...
                                        function getDateFromWeek(year, week) {
                                            ...
                                            const dayOfWeek = januaryFirst.getDay(); // Ngày trong tuần của ngày đầu năm
                                            const offset = (dayOfWeek <= 4 ? 1 - dayOfWeek : 8 - dayOfWeek); // Điều chỉnh cho ngày đầu tiên của tuần đầu tiên

                                            const firstMonday = new Date(year, 0, 1 + offset);
                                            firstMonday.setDate(firstMonday.getDate() + (week - 1) * 7); // Đầu tuần tính từ thứ 2
