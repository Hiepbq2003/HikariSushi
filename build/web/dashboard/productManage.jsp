...
<html>
    ...
    <body>
                        ...
                        <div class="card">
                            <div class="row" style="">
                                ...
                                <div class="col-lg-6" style="text-align: center; margin-top: 20px; margin-bottom: 20px;padding-top: 20px"F>
                                    <form action="manageProduct" method="post" style="display: flex; justify-content: center">
                        ...
                        <div class="card-body">
                            <div class="table-responsive"  id="contentt">
                                <table  class="table table-hover text-nowrap">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text_page_head" scope="col">Tên Sản Phẩm</th>
                                            <th class="text_page_head" style="text-align: center" scope="col">Ảnh</th>
                                            <th class="text_page_head" scope="col">Giá</th>
                                            <th class="text_page_head" scope="col">Hành Động</th>
                                        </tr>
                                    </thead>
                                    <tbody >
                                        <c:forEach items="${productsByPage}" var="o">
                                            <tr class="product_items">
                                                <td class="text_page">${o.productId}</td> 
                                                <td style="max-width: 280px;" class="text_page">${o.productName}</td>
                                                <td style="text-align: center">
                                                    <img style="width: 170px; height:180px" src="${o.img}">
                                                </td>
                                                <td class="text_page">${o.price} VNĐ</td>
                                                <td class="text_page">
                                                    <a href="updateproduct?productID=${o.productId}"><button type="button" class="btn btn-warning"><i class="fa-solid fa-pen"></i></button></a>
                                                    <a href="deleteproduct?productID=${o.productId}"><button type="button" class="btn btn-danger"><i class="fa-solid fa-trash"></i></button></a>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
                                ...
                                <div class="clearfix" style="text-align: center" >
                                    <ul class="pagination" >
                                        <c:if test="${page != 1}">
                                            <a class="page-item" href="manageProduct?page=${page-1}" >Previous</a>
                                        </c:if> 	
                                        <c:forEach begin="1" end="${numberpage}" var="i">
                                            <a class="${page==i?"page-item activee":""}" style="${page==i?"background-color:black; color: white; font-size: 22px; float: left; padding: 8px 16px; text-decoration: none;":""}" 
                                               href="manageProduct?page=${i}" class="page-link" >${i}</a>  
                                        </c:forEach>
                                        <c:if test="${page < numberpage}">
                                            <a class="page-item" href="manageProduct?page=${page+1 }" class="page-link" >Next</a>
                                        </c:if> 
                                    </ul>
                                </div>
        ...
        <div class="modal fade" id="addEmployeeModal" class="modal">
            <div class="modal-dialog" style="margin: 28px 250px">
                <div class="modal-content" style="width: 1000px; max-height: 900px; overflow: scroll">
                    
                    <form action="addproductmn" method="post" >
                        <div class="modal-header">						
                            <h4 class="modal-title">Tạo món mới</h4>
                        </div>
                        <div class="modal-body">					
                            ...
                            <div class="form-group">
                                ...
                                <select style="padding: 5px 0" name="category" class="form-select" aria-label="Default select example" required>
