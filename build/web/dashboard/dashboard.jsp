                                    ...
                                    <div style="padding: 10px 15px">
                                        <div class="d-flex justify-content-between p-md-1">
                                            ...
                                            <div style="text-align: end">
                                                <h4 style="color: #1B813A">Tổng số sản phẩm</h4>
                                                <p class="mb-0"></p>
                            ...
                            <div class="card">
                                <div style="padding: 10px 15px">
                                    <div class="d-flex justify-content-between p-md-1">
                                        ...
                                        <div style="text-align: end"> 
                                            <h4 style="color: #06439F;">Doanh Thu</h4>
                                            <p class="mb-0"></p>
                                            <h2 class="h1 mb-0">${requestScope.totalSales}</h2> 
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div style="padding: 10px 15px">
                                    <div class="d-flex justify-content-between p-md-1">
                                        ...
                                        <div style="text-align: end">
                                            <h4 style="color: #E94644;">Số đơn đã bán</h4>
                                            <p class="mb-0"></p>
                                            <h2 class="h1 mb-0">${requestScope.totalSold}</h2>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div style="padding: 10px 15px">
                                    <div class="d-flex justify-content-between p-md-1">
                                        ...
                                        <div style="text-align: end">
                                            <h4 style="color: #06439F;">Tổng số người dùng</h4>
                                            <p class="mb-0"></p>
                            ...
                            <div class="card">
                                <div style="padding: 10px 15px">
                                    <div class="d-flex justify-content-between p-md-1">
                                        ...
                                        <div style="text-align: end">
                                            <h4 style="color: black;">Số loại sản phẩm</h4>
                                            <p class="mb-0"></p>
                                            <h2 class="h1 mb-0">${requestScope.countProductType}</h2>
                                        </div>
                                    </div>
                                </div>
                            </div>
