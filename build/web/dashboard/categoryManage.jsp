                        ...
                        <div class="card">
                            <div class="row" style="">
                                <div class="col-lg-4" style="text-align: center; margin-top: 20px; margin-bottom: 20px;padding-top: 20px">
                                    <h3 class="mb-0" id="">
                                        <strong>Quản Lý Phân Loại Món</strong>
                                    </h3>
                                </div>
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text_page_head" scope="col">
                                                <a  style="margin-left: 620px" href="#addEmployeeModal"  class="btn btn-success" data-toggle="modal"><i class="fa-solid fa-plus"></i></a>
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody id="contentt">
                                        <c:forEach items="${listAllC}" var="o">
                                            <tr>
                                                <td class="text_page">${o.categoryId}</td>
                                                <td class="text_page">${o.categoryName}</td>
                                                <td class="text_page" style="padding: 0px 10px 30px 600px ">
                                                    <a href="updateCategory?category_id=${o.categoryId}"><button type="button" class="btn btn-warning"><i class="fa-solid fa-pen"></i></button></a>
                                                    <a href="deleteCategory?category_id=${o.categoryId}">
